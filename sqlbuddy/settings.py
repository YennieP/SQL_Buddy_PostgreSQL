...
"""
Django settings for SQL Buddy project.
Windows + PyMySQL version
"""

# ⭐⭐⭐ 必须在最开始：让Django使用PyMySQL
import pymysql
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "core.context_processors.user_role",  # 自定义context
            ],
        },
    },
]
...
# 验证必需的环境变量
REQUIRED_ENV_VARS = ["DB_NAME", "DB_USER", "DB_PASSWORD", "DB_HOST", "OPENAI_API_KEY"]
